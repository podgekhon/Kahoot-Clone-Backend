...
// Duplicate the tests with v1 and v2 functions
describe.each([
  {
    version: 'v1',
    requestAdminQuizCreate: requestAdminQuizCreate,
    requestAdminTrashEmpty: requestAdminTrashEmpty,
    requestAdminQuizRemove: requestAdminQuizRemove
  },
  {
    version: 'v2',
    requestAdminQuizCreate: requestAdminQuizCreateV2,
    requestAdminTrashEmpty: requestAdminTrashEmptyV2,
    requestAdminQuizRemove: requestAdminQuizRemoveV2
  }
])('Tests for $version adminTrashEmpty',
  ({
    requestAdminQuizCreate,
    requestAdminTrashEmpty,
    requestAdminQuizRemove
